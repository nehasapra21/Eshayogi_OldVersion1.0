...
export default class ManageDirectory extends Component {
  constructor(props) {
    ...
    document.title = 'Manage Calling Direactory'
  ...
  updateCaller = (data) => {
    let callerData = { ...data }
    delete callerData.meta
    this.props.history.push({
      pathname: '/add-calling-directory',
      state: {
        ...callerData,
        ...
        <div className="frame2" style={{ marginTop: '100px' }}>
          <div className="FormOuterFrame">
            ...
            >
              ...
              <Link style={{ marginLeft: '26%' }} to={'/add-calling-directory'}>
                ...
                <Autocomplete
                  ...
                  onChange={(event, value) => {
                    if (value !== null && value !== undefined) {
                      ...
                      this.setState({ panchayat: '' }, () => this.fetchCaller())
                    }
                  }}
                  renderInput={(params) => (
                            ...
                            <Table.Cell>
                              {this.state.role === 'USER' ? null : (
                                <img
                                  ...
                                  onClick={() => this.deleteCaller(data.id)}
                                ></img>
                              )}
                            </Table.Cell>
                            <Table.Cell onClick={() => this.updateCaller(data)}>

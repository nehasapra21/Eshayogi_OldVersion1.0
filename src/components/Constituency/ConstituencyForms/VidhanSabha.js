        ...
        {this.showWarning ? (
          ...
          <Fragment>
            ...
            >
              ...
              {console.log('this.district[0]', this.district[0])}
              <Typeahead
                id='district hide-scroll'
                labelKey='district'
            ...
            <ConstituencyAlert msg = 'Vidhan Sabha Updated' showConfirmBox = { this.showConfirmBox } location = {'/manage-constituency'} /> : 
            <ConstituencyAlert msg = 'Vidhan Sabha Created' showConfirmBox = { this.showConfirmBox } location = {'/add-constituency'} /> :
            null
          } */}
          </Fragment>
        )}

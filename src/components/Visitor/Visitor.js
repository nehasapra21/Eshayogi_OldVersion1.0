...
class VisitorForm extends Component {
  ...
  handleAddVisitor = () => {
    ...
    delete visitorInfo.errors
    delete visitorInfo.isUpdateRequest
    delete visitorInfo.isUpdateRequest
    delete visitorInfo.districtOption
    delete visitorInfo.vidhanSabhaOption
    delete visitorInfo.panchayatOption
    delete visitorInfo.state
    delete visitorInfo.block
    delete visitorInfo.isDisabled
        ...
        <div className="frame">
          <div className="FormOuterFrame">
            <div className="DivHeading">
              <p className="TxtHeading">Visitor</p>
            </div>
            <div className="FormFrame">
              <form onSubmit={this.makeLetterCapital}>
                ...
                <div className="TxtInputFrame">
                  <p className="TxtInput">Visitor Name</p>
                  <p className="TxtStar">*</p>
                </div>
                <input
                  type="text"
                ...
                <div className="TxtInputFrame">
                  <p className="TxtInput">Purpose of Visit</p>
                </div>
                <textarea
                  type="text"
                  id="purposeOfVisit"

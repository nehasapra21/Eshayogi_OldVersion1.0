...
class ManagePoliticalEvent extends Component {
  constructor(props) {
    document.title = 'Political Event Management Panel';
    super(props);
    this.state = {
      page: 0,
      rowsPerPage: 25,
  ...
  historyFunction(request) {
    ...
    this.props.history.push({
      ...
      state: { event: request },
      search: '?show-politicalevent',
    });
  }

  render(props) {
    var array = this.props.events;
            ...
            <Table celled>
              <Table.Header>
                <Table.Row>
                  ...
                  <Table.HeaderCell style={{ width: '22%' }}>
                  ...
                  <Table.HeaderCell id='statusherder' style={{ width: '16%' }}>
                    ...
                    <Table.Row>
                      ...
                      <Table.Cell>
                        <div>
                          ...
                          <p className='DataTxt1' style={{ fontWeight: '900' }}>
...
export default ManagePoliticalEvent;

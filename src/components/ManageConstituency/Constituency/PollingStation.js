...
export default class PollingStation extends Component {
  ...
  render() {
    let pollingStationData = JSON.parse(localStorage.getItem('Polling Station'))
    ...
    return (
      <Fragment>
        <div className="FormOuterFrame">
          ...
          {pollingStationData?.length !== 0 ? (
            pollingStationData.rows
              .slice(
          ...
          <TablePagination
            ...
            component="div"
            count={pollingStationData?.count || 0}
